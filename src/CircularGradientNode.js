(function(TextureGen) {
  ...
  function CircularGradientNode(id) {
    TextureGen.CanvasNode.call(this, id, 'CircularGradient', ['x', 'y', 'radius']);
    this.type = 'CircularGradientNode';
  }

  CircularGradientNode.prototype = Object.create(TextureGen.CanvasNode.prototype, {
    render: {
      value: function() {
        if(!this.dirty) {
          return;
